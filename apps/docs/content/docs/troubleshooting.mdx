...
2. If you created `env.ts` in this session, run `npx typebase-io-cli codegen`. Adding or removing the file changes the handler context; editing the keys inside an existing one doesn't.
