...
There's no technical difference between a "query" and a "mutation" in Typebase — they're both actions. The distinction is purely organizational. A mutation is just an action that writes data:
