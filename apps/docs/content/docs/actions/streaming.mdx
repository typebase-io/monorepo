...
This works whether or not the action declares `.output()`; both report the same type. See [Typing action inputs and outputs](/docs/client#typing-action-inputs-and-outputs).
