...
5. **Pushes your database schema**: Syncs your Drizzle schema to your Neon database (if applicable).
...
<Callout type="warn">
  Schema changes are applied (step 5) before the new server code is live (step 6). This is normal for most deployment workflows, but it means the
