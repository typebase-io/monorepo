...
After running `npx typebase-io-cli deploy`, the CLI saves your server URL to `.env` as `TYPEBASE_APP_URL`. Expo requires a different prefix for variables exposed to the app — add this to your `.env` file:
