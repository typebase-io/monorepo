...
After running `npx typebase-io-cli deploy`, the CLI saves your server URL to `.env` as `TYPEBASE_APP_URL`. Use this for all server-side calls (load functions, form actions).
