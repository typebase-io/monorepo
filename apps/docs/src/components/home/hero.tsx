      ...
      <div className="mx-auto max-w-6xl px-6 pt-20 pb-24 sm:pt-28 sm:pb-32">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <p className="mx-auto mt-6 max-w-2xl text-lg text-fd-muted-foreground sm:text-xl">
            Write your actions, database schema, and auth as TypeScript files. Run one command. Your frontend calls them like local functions —
            end-to-end typed, zero REST boilerplate.
          </p>
        ...
        <div className="mt-20 grid gap-6 lg:grid-cols-[1fr_auto_1fr] items-stretch">
          ...
          <div className="flex flex-col items-center justify-center gap-1 py-2 lg:py-0">
            <div className="text-fd-muted-foreground text-sm">generates</div>
            <ArrowRight className="h-6 w-6 text-fd-primary rotate-90 lg:rotate-0" />
            <div className="text-fd-muted-foreground text-sm">types for</div>
          </div>
